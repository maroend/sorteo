...
import com.sorteo.reportes.model.mBoletosPerdidosColaborador;

/**
 * Servlet implementation class BoletosPerdidosColaborador
 */
@WebServlet("/BoletosPerdidosColaborador")
public class BoletosPerdidosColaborador extends HttpServlet {
     ...
     */
    public BoletosPerdidosColaborador() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mBoletosPerdidosColaborador model = new mBoletosPerdidosColaborador();
	   ...
	   case "GetComprador":
		...
		default:
			...
			fullPath = "/WEB-INF/views/reportes/boletosperdidoscolaborador.html";
			menu = vista.initMenu(0, false, 19, sesion.misSorteos==0 ? 22 : 19, sesion);
	...
	protected void SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mBoletosPerdidosColaborador model, SesionDatos sesion) throws ServletException, IOException {
	...
	protected String getBoletosTalonarios(mBoletosPerdidosColaborador model, SesionDatos sesion) {
	...
	protected String getBoletosTalonariosSector(int idsorteo, int idsector, mBoletosPerdidosColaborador model) {
	...
	protected String getBoletosTalonariosNicho(int idsorteo, int idsector,
			int idnicho, mBoletosPerdidosColaborador model) {
	...
	protected String getBoletosTalonariosColaborador(int idsorteo,
			int idsector, int idnicho, int idcolaborador, mBoletosPerdidosColaborador model) {
	...
	protected String GetComprador(int idsorteo, String boleto, String talonario, mBoletosPerdidosColaborador model) {
   ...
   protected String GetIncidenciaBoleto(int idsorteo, String boleto, String talonario, mBoletosPerdidosColaborador model){
   ...
   protected String BuscarMontoAbonoTalonario(int idsorteo, String talonario, mBoletosPerdidosColaborador model){
   ...
   protected String BuscarBoletosTalonarios(int idsorteo, String talonario, mBoletosPerdidosColaborador model){
	   String contenido = "";
	   ResultSet rs = null;
	   String estado = "";
	...
	protected void Buscar(HttpServletRequest request,
			...
			mBoletosPerdidosColaborador model, SesionDatos sesion)
