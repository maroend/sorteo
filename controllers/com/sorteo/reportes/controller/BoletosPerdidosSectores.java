...
import com.sorteo.reportes.model.mBoletosPerdidosSectores;

/**
 * Servlet implementation class BoletosPerdidosSectores
 */
@WebServlet("/BoletosPerdidosSectores")
public class BoletosPerdidosSectores extends HttpServlet {
     ...
     */
    public BoletosPerdidosSectores() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mBoletosPerdidosSectores model = new mBoletosPerdidosSectores();
		...
		default:
			...
			fullPath = "/WEB-INF/views/reportes/boletosperdidossectores.html";
			menu = vista.initMenu(0, false, 19, sesion.misSorteos == 0 ? 22
					: 19, sesion);
			notificaciones = vista.initNotificaciones(context,
					sesion.nombreCompleto);
	...
	protected void SorteoPredeterminado(HttpServletRequest request,
			...
			mBoletosPerdidosSectores model, SesionDatos sesion)
	...
	protected String getBoletosTalonarios(mBoletosPerdidosSectores model,
			SesionDatos sesion) {
	...
	protected String getBoletosTalonariosSector(int idsorteo, int idsector,
			mBoletosPerdidosSectores model) {
	...
	protected String getBoletosTalonariosNicho(int idsorteo, int idsector,
			int idnicho, mBoletosPerdidosSectores model) {
	...
	protected String GetComprador(int idsorteo, String boleto,
			String talonario, mBoletosPerdidosSectores model) {
	...
	protected void Buscar(HttpServletRequest request,
			HttpServletResponse response, int pg, int show, String search, mBoletosPerdidosSectores model, SesionDatos sesion)
			throws ServletException, IOException {
		...
		String HTML = CrearTabla(numeroregistros, model.paginacion(pg, show, search,sesion.pkSorteo,sesion.pkSector), columnas, campos, pg, show, model, sesion);
		PrintWriter out = response.getWriter();
		out.println(HTML);
	}

	protected String CrearTabla(int numreg, ResultSet rs, String[] columnas,
			String[] campos, int pg, int show, mBoletosPerdidosSectores model,
			SesionDatos sesion) {
