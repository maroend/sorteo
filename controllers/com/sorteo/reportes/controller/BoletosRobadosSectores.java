...
import com.sorteo.reportes.model.mBoletosRobadosSectores;

/**
 * Servlet implementation class BoletosRobadosSectores
 */
@WebServlet("/BoletosRobadosSectores")
public class BoletosRobadosSectores extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mBoletosRobadosSectores model = new mBoletosRobadosSectores();
				...
				if (!sesion.permisos.havePermiso(20101)){view = "error";}
			   ...
			   case "GetComprador":
				...
				default:
					...
					fullPath = "/WEB-INF/views/reportes/boletosrobadossectores.html";
					menu = vista.initMenu(0, false, 19, sesion.misSorteos==0 ? 1033 : 19, sesion);
					notificaciones = vista.initNotificaciones(context,
							sesion.nombreCompleto);
					infouser = vista.initInfoUser(context, sesion.nombreCompleto,sesion.role);
	...
	protected void SorteoPredeterminado(HttpServletRequest request,
			HttpServletResponse response, String HTML, mBoletosRobadosSectores model, SesionDatos sesion) throws ServletException,
			IOException {
			 ...
			 protected String getBoletosTalonarios(mBoletosRobadosSectores model, SesionDatos sesion){
		   ...
		   protected String getBoletosTalonariosSector(int idsorteo, int idsector, mBoletosRobadosSectores model){
		  ...
		  protected String getBoletosTalonariosNicho(int idsorteo, int idsector,int idnicho, mBoletosRobadosSectores model){
		  ...
		  protected String getBoletosTalonariosColaborador(int idsorteo, int idsector,int idnicho, int idcolaborador, mBoletosRobadosSectores model){
			  ...
			  String contenido = "";
			    ...
			    protected String GetComprador(int idsorteo, String boleto, String talonario, mBoletosRobadosSectores model){
		   ...
		   protected String GetIncidenciaBoleto(int idsorteo, String boleto, String talonario, mBoletosRobadosSectores model){
		   ...
		   protected String BuscarMontoAbonoTalonario(int idsorteo, String talonario, mBoletosRobadosSectores model){
		   ...
		   protected String BuscarBoletosTalonarios(int idsorteo, String talonario, mBoletosRobadosSectores model){
			   String contenido = "";
			   ResultSet rs = null;
			   String estado = "";
	...
	protected void Buscar(HttpServletRequest request,
			HttpServletResponse response, int pg, int show, String search, mBoletosRobadosSectores model, SesionDatos sesion)
	...
	protected String CrearTabla(int numreg, ResultSet rs, String[] columnas,
		...
		if (Integer.valueOf(numreg) > 0) {	
			...
			html += "<h1>No existen Boletos Perdidos en el Sector </h1>";		
			html += "</div>";
			html += "</td></tr>";
	   }			
