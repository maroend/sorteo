...
import com.sorteo.ventas.model.mCompradoresColaborador;

/**
 * Servlet implementation class CompradoresColaborador
 */          
@WebServlet("/CompradoresColaborador")
public class CompradoresColaborador extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mCompradoresColaborador model = new mCompradoresColaborador();
	   ...
	   case "GetComprador":
		...
		default:
			...
			fullPath = "/WEB-INF/views/ventas/compradorescolaborador.html";
			menu = vista.initMenu(0, false, 19, 15, sesion);
			notificaciones = vista.initNotificaciones(context,
					sesion.nombreCompleto);
			infouser = vista.initInfoUser(context, sesion.nombreCompleto,sesion.role);
	 ...
	 protected void SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mCompradoresColaborador model, SesionDatos sesion) throws ServletException, IOException {
	 ...
	 protected String getBoletosTalonarios(mCompradoresColaborador model, SesionDatos sesion){
   ...
   protected String getBoletosTalonariosSector(int idsorteo, int idsector, mCompradoresColaborador model){
  ...
  protected String getBoletosTalonariosNicho(int idsorteo, int idsector,int idnicho, mCompradoresColaborador model){
	...
	protected String GetComprador(int idsorteo, String boleto,
			String talonario, mCompradoresColaborador model) {
	...
	protected String GetIncidenciaBoleto(int idsorteo, String boleto, String talonario, mCompradoresColaborador model) {
   ...
   protected String BuscarMontoAbonoTalonario(int idsorteo, String talonario, mCompradoresColaborador model){
	...
	protected void Buscar(HttpServletRequest request,
			HttpServletResponse response, int pg, int show, String search, mCompradoresColaborador model, SesionDatos sesion)
			throws ServletException, IOException {

		String[] columnas = { "Boleto","Estatus","Costo","Abono","Talonario","Comprador"};
		String[] campos = { "FOLIO","VENDIDO","COSTO","ABONO","TALONARIO","COMPRADOR"};
	...
	if (Integer.valueOf(numreg) > 0) {	
		...
		html += "<h1>No existen Compradores del Colaborador</h1>";
