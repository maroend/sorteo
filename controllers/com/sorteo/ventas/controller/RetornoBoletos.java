...
import com.sorteo.ventas.model.mRetornoBoletos;

/**
 * Servlet implementation class RetornoBoletos
 */
@WebServlet("/RetornoBoletos")
public class RetornoBoletos extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mRetornoBoletos model = new mRetornoBoletos();
	   ...
	   case "GetComprador":
		...
		default:
			...
			fullPath = "/WEB-INF/views/ventas/retornoboletos.html";
			menu = vista.initMenu(0, false, 19, 13, sesion);
			notificaciones = vista.initNotificaciones(context,
					sesion.nombreCompleto);
			infouser = vista.initInfoUser(context, sesion.nombreCompleto,sesion.role);
	...
	protected String getSorteosUsuarios(HttpServletRequest request, HttpServletResponse response, String HTML, SesionDatos sesion) throws ServletException, IOException {
	 ...
	 protected void SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mRetornoBoletos model, SesionDatos sesion) throws ServletException, IOException {
	 ...
	 protected String getBoletosTalonarios(mRetornoBoletos model, SesionDatos sesion){
   ...
   protected String getBoletosTalonariosSector(int idsorteo, int idsector, mRetornoBoletos model){
  ...
  protected String getBoletosTalonariosNicho(int idsorteo, int idsector,int idnicho, mRetornoBoletos model){
  ...
  protected String getBoletosTalonariosColaborador(int idsorteo, int idsector,int idnicho, int idcolaborador, mRetornoBoletos model){
	  ...
	  String contenido = "";
	    ...
	    protected String GetComprador(int idsorteo, String boleto, String talonario, mRetornoBoletos model){
   ...
   protected String GetIncidenciaBoleto(int idsorteo, String boleto, String talonario, mRetornoBoletos model){
   ...
   protected String BuscarMontoAbonoTalonario(int idsorteo, String talonario, mRetornoBoletos model){
   ...
   protected String BuscarBoletosTalonarios(int idsorteo, String talonario, mRetornoBoletos model){
	   String contenido = "";
	   ResultSet rs = null;
	   String estado = "";
	...
	protected void Buscar(HttpServletRequest request,
			HttpServletResponse response, int pg, int show, String search, mRetornoBoletos model, SesionDatos sesion)
        ...
        int numeroregistros = model.contar(sesion.pkSorteo,search);
	...
	protected String CrearTabla(int numreg, ResultSet rs, String[] columnas,
		...
		if (Integer.valueOf(numreg) > 0) {		
			...
			while (rs.next()) {
				...
				html += "<h1>No existen Boletos Retornados</h1>";
