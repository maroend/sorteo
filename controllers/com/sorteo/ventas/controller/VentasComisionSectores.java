...
import com.sorteo.ventas.model.mVentasComisionSectores;;

/**
 * Servlet implementation class Ventas
 */
@WebServlet("/VentasComisionSectores")
public class VentasComisionSectores extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mVentasComisionSectores model = new mVentasComisionSectores();
	...
	protected boolean SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mVentasComisionSectores model, SesionDatos sesion) throws ServletException, IOException {
	...
	private String Contenido(String HTML,int idsorteo, mVentasComisionSectores model) {
		...
		contenido = contenido.replaceAll("#SECTOR#", "");
		...
		*/
		...
		try {
			while (rs.next()) {
				...
				dato += "<tr>";
				dato += "<td><span style=\"display:none;\" id=\"sector"+rs.getString("PK1")+"\"><i class=\"fa fa-lg fa-plus-square\"></i></span><a href=\"VentasComisionSector?sorteo="+idsorteo+"&sector="+rs.getString("PK1")+"\">"+rs.getString("SECTOR")+"</a></td>";
