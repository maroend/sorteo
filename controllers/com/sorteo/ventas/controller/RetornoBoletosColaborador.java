...
import com.sorteo.ventas.model.mRetornoBoletosColaborador;

/**
 * Servlet implementation class RetornoBoletosNichos
 */          
@WebServlet("/RetornoBoletosColaborador")
public class RetornoBoletosColaborador extends HttpServlet {
     ...
     */
    public RetornoBoletosColaborador() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mRetornoBoletosColaborador model = new mRetornoBoletosColaborador();
       ...
       case "getBoletosTalonariosColaborador":
           ...
           idcolaborador= sesion.pkColaborador;  
	   ...
	   case "GetComprador":
		...
		default:
			...
			fullPath = "/WEB-INF/views/ventas/retornoboletoscolaborador.html";	
			...
			model.setIcolaborador(sesion.pkColaborador);
	 ...
	 protected void SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mRetornoBoletosColaborador model, SesionDatos sesion) throws ServletException, IOException {
	 ...
	 protected String getBoletosTalonarios(mRetornoBoletosColaborador model, SesionDatos sesion){
   ...
   protected String getBoletosTalonariosSector(int idsorteo, int idsector, mRetornoBoletosColaborador model){
  ...
  protected String getBoletosTalonariosNicho(int idsorteo, int idsector,int idnicho, mRetornoBoletosColaborador model){
  ...
  protected String getBoletosTalonariosColaborador(int idsorteo, int idsector,int idnicho, int idcolaborador, mRetornoBoletosColaborador model){
	  ...
	  String contenido = "";
	    ...
	    protected String GetComprador(int idsorteo, String boleto, String talonario, mRetornoBoletosColaborador model){
   ...
   protected String GetIncidenciaBoleto(int idsorteo, String boleto, String talonario, mRetornoBoletosColaborador model){
   ...
   protected String BuscarMontoAbonoTalonario(int idsorteo, String talonario, mRetornoBoletosColaborador model){
   ...
   protected String BuscarBoletosTalonarios(int idsorteo, String talonario, mRetornoBoletosColaborador model){
	   String contenido = "";
	   ResultSet rs = null;
	   String estado = "";
	...
	protected void Buscar(HttpServletRequest request,
			...
			mRetornoBoletosColaborador model, SesionDatos sesion)
	...
	protected String CrearTabla(int numreg, ResultSet rs, String[] columnas,
		...
		if (Integer.valueOf(numreg) > 0) {		
			...
			html += "<h1>No existen Boletos Retornados del Colaborador</h1>";
