...
import com.sorteo.ventas.model.mVentasNicho;

/**
 * Servlet implementation class Ventas
 */
@WebServlet("/VentasNicho")
public class VentasNicho extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mVentasNicho model = new mVentasNicho();
	...
	protected void SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mVentasNicho model, SesionDatos sesion) throws ServletException, IOException {
	...
	private String Contenido(String HTML, int idsorteo, int idsector, int idnicho, mVentasNicho model){
