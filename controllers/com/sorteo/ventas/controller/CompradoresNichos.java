...
import com.sorteo.ventas.model.mCompradoresNichos;

/**
 * Servlet implementation class CompradoresNichos
 */          
@WebServlet("/CompradoresNichos")
public class CompradoresNichos extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mCompradoresNichos model = new mCompradoresNichos();
	   ...
	   case "GetComprador":
		...
		default:
			...
			fullPath = "/WEB-INF/views/ventas/compradoresnichos.html";
			menu = vista.initMenu(0, false, 19, 15, sesion);
			notificaciones = vista.initNotificaciones(context,
					sesion.nombreCompleto);
			infouser = vista.initInfoUser(context, sesion.nombreCompleto,sesion.role);
	 ...
	 protected void SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mCompradoresNichos model, SesionDatos sesion) throws ServletException, IOException {
	 ...
	 protected String getBoletosTalonarios(mCompradoresNichos model, SesionDatos sesion){
   ...
   protected String getBoletosTalonariosSector(int idsorteo, int idsector, mCompradoresNichos model){
  ...
  protected String getBoletosTalonariosNicho(int idsorteo, int idsector,int idnicho, mCompradoresNichos model){
  ...
  protected String getBoletosTalonariosColaborador(int idsorteo, int idsector,int idnicho, int idcolaborador, mCompradoresNichos model){
	  ...
	  String contenido = "";
	    ...
	    protected String GetComprador(int idsorteo, String boleto, String talonario, mCompradoresNichos model){
   ...
   protected String GetIncidenciaBoleto(int idsorteo, String boleto, String talonario, mCompradoresNichos model){
   ...
   protected String BuscarMontoAbonoTalonario(int idsorteo, String talonario, mCompradoresNichos model){
   ...
   protected String BuscarBoletosTalonarios(int idsorteo, String talonario, mCompradoresNichos model){
	   String contenido = "";
	   ResultSet rs = null;
	   String estado = "";
	 ...
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response, mCompradoresNichos model) throws ServletException, IOException {
		// TODO Auto-generated method stub
	}
	
	protected void Buscar(HttpServletRequest request,
			HttpServletResponse response, int pg, int show, String search, mCompradoresNichos model, SesionDatos sesion)
			throws ServletException, IOException {

		String[] columnas = { "Boleto","Estatus","Costo","Abono","Talonario","Comprador","Colaborador"};
		String[] campos = { "FOLIO","VENDIDO","COSTO","ABONO","TALONARIO","COMPRADOR","COLABORADOR"};
	...
	protected String CrearTabla(int numreg, ResultSet rs, String[] columnas,
		...
		if (Integer.valueOf(numreg) > 0) {	
			...
			html += "<h1>No existen Compradores en el Nicho</h1>";
