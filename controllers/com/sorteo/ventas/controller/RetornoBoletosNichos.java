...
import com.sorteo.ventas.model.mRetornoBoletosNichos;

/**
 * Servlet implementation class RetornoBoletosNichos
 */          
@WebServlet("/RetornoBoletosNichos")
public class RetornoBoletosNichos extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mRetornoBoletosNichos model = new mRetornoBoletosNichos();
	   ...
	   case "GetComprador":
		...
		default:
			...
			fullPath = "/WEB-INF/views/ventas/retornoboletosnichos.html";
			menu = vista.initMenu(0, false, 19, 13, sesion);
			notificaciones = vista.initNotificaciones(context,
					sesion.nombreCompleto);
			infouser = vista.initInfoUser(context, sesion.nombreCompleto,sesion.role);
	 ...
	 protected void SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mRetornoBoletosNichos model, SesionDatos sesion) throws ServletException, IOException {
	 ...
	 protected String getBoletosTalonarios(mRetornoBoletosNichos model, SesionDatos sesion){
   ...
   protected String getBoletosTalonariosSector(int idsorteo, int idsector, mRetornoBoletosNichos model){
  ...
  protected String getBoletosTalonariosNicho(int idsorteo, int idsector,int idnicho, mRetornoBoletosNichos model){
  ...
  protected String getBoletosTalonariosColaborador(int idsorteo, int idsector,int idnicho, int idcolaborador, mRetornoBoletosNichos model){
	  ...
	  String contenido = "";
	    ...
	    protected String GetComprador(int idsorteo, String boleto, String talonario, mRetornoBoletosNichos model){
   ...
   protected String GetIncidenciaBoleto(int idsorteo, String boleto, String talonario, mRetornoBoletosNichos model){
   ...
   protected String BuscarMontoAbonoTalonario(int idsorteo, String talonario, mRetornoBoletosNichos model){
   ...
   protected String BuscarBoletosTalonarios(int idsorteo, String talonario, mRetornoBoletosNichos model){
	   String contenido = "";
	   ResultSet rs = null;
	   String estado = "";
	...
	protected void Buscar(HttpServletRequest request,
			HttpServletResponse response, int pg, int show, String search, mRetornoBoletosNichos model, SesionDatos sesion)
	...
	protected String CrearTabla(int numreg, ResultSet rs, String[] columnas,
		...
		if (Integer.valueOf(numreg) > 0) {	
			...
			html += "<h1>No existen Boletos Retornados en el Nicho</h1>";			
			html += "</div>";
			html += "</td></tr>";
}				
