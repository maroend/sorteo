...
import com.sorteo.ventas.model.mCompradoresSectores;

/**
 * Servlet implementation class CompradoresSectores
 */          
@WebServlet("/CompradoresSectores")
public class CompradoresSectores extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mCompradoresSectores model = new mCompradoresSectores();
	   ...
	   case "GetComprador":
		...
		default:
			...
			fullPath = "/WEB-INF/views/ventas/compradoressectores.html";
			menu = vista.initMenu(0, false, 19, 15, sesion);
			notificaciones = vista.initNotificaciones(context,
					sesion.nombreCompleto);
			infouser = vista.initInfoUser(context, sesion.nombreCompleto,sesion.role);
	...
	protected void SorteoPredeterminado(HttpServletRequest request, HttpServletResponse response, String HTML, mCompradoresSectores model, SesionDatos sesion) throws ServletException, IOException {
	 ...
	 protected String getBoletosTalonarios(mCompradoresSectores model, SesionDatos sesion){
   ...
   protected String getBoletosTalonariosSector(int idsorteo, int idsector, mCompradoresSectores model){
  ...
  protected String getBoletosTalonariosNicho(int idsorteo, int idsector,int idnicho, mCompradoresSectores model){
	...
	protected String GetComprador(int idsorteo, String boleto,
			String talonario, mCompradoresSectores model) {
   ...
   protected String GetIncidenciaBoleto(int idsorteo, String boleto, String talonario, mCompradoresSectores model){
   ...
   protected String BuscarMontoAbonoTalonario(int idsorteo, String talonario, mCompradoresSectores model){
   ...
   protected String BuscarBoletosTalonarios(int idsorteo, String talonario, mCompradoresSectores model){
	   String contenido = "";
	   ResultSet rs = null;
	   String estado = "";
	...
	protected void Buscar(HttpServletRequest request,
			HttpServletResponse response, int pg, int show, String search, mCompradoresSectores model, SesionDatos sesion)
			throws ServletException, IOException {

		String[] columnas = { "Boleto","Estatus","Costo","Abono","Talonario","Comprador","Nicho","Colaborador"};
		String[] campos = { "FOLIO","VENDIDO","COSTO","ABONO","TALONARIO","COMPRADOR","NICHO","COLABORADOR"};
	...
	if (Integer.valueOf(numreg) > 0) {			
			...
			while (rs.next()) {
				...
				html += "<h1>No existen Compradores en el Sector</h1>";
