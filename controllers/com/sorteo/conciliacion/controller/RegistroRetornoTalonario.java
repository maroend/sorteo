 ...
 */
@WebServlet("/RegistroRetornoTalonario")
public class RegistroRetornoTalonario extends HttpServlet {
	 ...
	 */
	public RegistroRetornoTalonario() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		default:
			...
			String fullPath = "/WEB-INF/views/conciliacion/RegistroRetornoTalonario.html";
