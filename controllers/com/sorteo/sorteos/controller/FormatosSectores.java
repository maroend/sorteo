...
import com.sorteo.sorteos.model.mFormatosSectores;

/**
 * Servlet implementation class BoletosSorteosSectores
 */
@WebServlet("/FormatosSectores")
public class FormatosSectores extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SesionDatos sesion;
		mFormatosSectores model = new mFormatosSectores();
		...
		//10026 ACCESO A LA LISTA DE FORMATOS		
		 if (!sesion.permisos.havePermiso(10175)){view = "error";}
		...
		default:
			...
			fullPath = "/WEB-INF/views/sorteos/formatos/FormatosSectores.html";
	...
	protected void Buscar(HttpServletRequest request,
			HttpServletResponse response, int pg, int show, String search, mFormatosSectores model, SesionDatos sesion)
			throws ServletException, IOException {

		String[] columnas = { "Folio","Id boleto","Id Sector","Estado","Usuario","Fecha Registro"};
		String[] campos = { "FOLIO","PK_BOLETO","PK_SECTOR","PK_ESTADO","USUARIO","FECHA_R" };
		int numeroregistros = model.contar(sesion.pkSorteo,sesion.pkSector,search);

		
		String HTML = CrearTabla(numeroregistros, model.paginacion(pg, show, search,sesion.pkSorteo,sesion.pkSector), columnas, campos, pg, show);
		PrintWriter out = response.getWriter();
		out.println(HTML);
