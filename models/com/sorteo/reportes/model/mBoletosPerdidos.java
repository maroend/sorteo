...
public class mBoletosPerdidos extends SuperModel  {
	...
	public int contar(String search,int idsorteo) {
		...
		sql += " FROM SORTEOS_BOLETOS R, BOLETOS B,BOLETOS_INCIDENCIAS I WHERE R.PK_BOLETO = B.PK1 AND B.PK1 = I.PK_BOLETO AND I.INCIDENCIA = 'E' AND R.PK_SORTEO = '"+idsorteo+"'";
	...
	public ResultSet paginacion(int pg, int numreg, String search,int idsorteo) {
		...
		//sql += "FROM SORTEOS_BOLETOS SB, BOLETOS B WHERE R.PK_BOLETO = B.PK1 AND R.PK_SORTEO = '"+idsorteo+"'";
		...
		String sql = "SELECT S.PK_BOLETO,B.VENDIDO,B.ABONO,B.PK1,B.FOLIO,B.COSTO, B.TALONARIO, B.FORMATO, B.SORTEO, B.PK_TALONARIO, B.INCIDENCIA, "
			...
			+ "FROM SORTEOS_BOLETOS S, BOLETOS B, BOLETOS_INCIDENCIAS I WHERE S.PK_BOLETO = B.PK1 AND S.PK_BOLETO = I.PK_BOLETO AND S.PK_SORTEO = '"+idsorteo+"' AND I.INCIDENCIA = 'E'";
