...
public class mBoletosRobadosColaborador  extends SuperModel {
	...
	public mBoletosRobadosColaborador() {
	...
	public int contar(String search,int idsorteo, int idsector, int idnicho,int idcolaborador) {
		...
		sql += " FROM SORTEOS_COLABORADORES_BOLETOS SB, BOLETOS B,BOLETOS_INCIDENCIAS I WHERE SB.PK_BOLETO = B.PK1 AND B.PK1 = I.PK_BOLETO AND I.INCIDENCIA = 'R' AND SB.PK_SORTEO = '"+idsorteo+"' AND SB.PK_SECTOR = '"+idsector+"' AND SB.PK_NICHO = '"+idnicho+"' AND SB.PK_COLABORADOR = '"+idcolaborador+"' ";
	...
	String sql = "SELECT S.PK_BOLETO,B.VENDIDO,B.ABONO,B.PK1,B.FOLIO,B.COSTO, B.TALONARIO, B.FORMATO, B.SORTEO, B.PK_TALONARIO, B.INCIDENCIA, "
			...
			+ "FROM SORTEOS_COLABORADORES_BOLETOS S, BOLETOS B, BOLETOS_INCIDENCIAS I WHERE S.PK_BOLETO = B.PK1 AND S.PK_BOLETO = I.PK_BOLETO AND S.PK_SORTEO = '"+idsorteo+"' AND S.PK_SECTOR = '"+idsector+"' AND S.PK_NICHO = '"+idnicho+"' AND S.PK_COLABORADOR = '"+idcolaborador+"' AND I.INCIDENCIA = 'R'";
		...
		System.out.println(">>>>SQL ROB COL:"+sql);
