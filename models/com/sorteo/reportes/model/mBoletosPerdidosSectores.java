...
public class mBoletosPerdidosSectores extends SuperModel  {
	...
	public mBoletosPerdidosSectores() {
	...
	public int contar(String search, int idsorteo, int idsector) {
		...
		sql += " FROM SORTEOS_SECTORES_BOLETOS SB, BOLETOS B,BOLETOS_INCIDENCIAS I WHERE SB.PK_BOLETO = B.PK1 AND B.PK1 = I.PK_BOLETO AND I.INCIDENCIA = 'E' AND SB.PK_SORTEO = '"+idsorteo+"' AND SB.PK_SECTOR = '"+idsector+"'";
	...
	String sql = "SELECT S.PK_BOLETO,B.VENDIDO,B.ABONO,B.PK1,B.FOLIO,B.COSTO, B.TALONARIO, B.FORMATO, B.SORTEO, B.PK_TALONARIO, B.INCIDENCIA, "
			...
			+ "FROM SORTEOS_SECTORES_BOLETOS S, BOLETOS B, BOLETOS_INCIDENCIAS I WHERE S.PK_BOLETO = B.PK1 AND S.PK_BOLETO = I.PK_BOLETO AND S.PK_SORTEO = '"+idsorteo+"' AND S.PK_SECTOR = '"+idsector+"' AND I.INCIDENCIA = 'E'";
