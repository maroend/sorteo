...
public class mRegistroIncidencia extends SuperModel {
	...
	public mRegistroIncidencia() {
		init();
	}
	
	public String getTalonario(mRegistroIncidencia obj,int pk_sorteo){
	...
	public ResultSet getSectoresUsuario(mRegistroIncidencia obj) {
	...
	public void getSectorNicho(mRegistroIncidencia obj) {
	...
	public int Borrar(mRegistroIncidencia obj) {
	...
	public void actualizarAbono(mRegistroIncidencia obj) {
