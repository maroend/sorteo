...
public class mVentasComisionSectores extends SuperModel {
	...
	public mVentasComisionSectores() {
	...
	public void Sorteo(mVentasComisionSectores obj){
	...
	public void Totaltalonarios(mVentasComisionSectores obj){
	...
	public double montoSorteo(mVentasComisionSectores obj){
	...
	public void TotaltalonariosAsignados(mVentasComisionSectores obj){
	...
	public void TotalboletosVendidos(mVentasComisionSectores obj){
	...
	/*
	public double TotalboletosVenta(mVentasComisionSectores obj){
	...
	*/
	/*
	public int TotalboletosSectorVendidos(mVentasComisionSectores obj) {
		int total = 0;
		db.con();
	...
	*/
	public double TotalboletosSectorVenta(mVentasComisionSectores obj) {
		double total = 0;
	...
	public double TotalboletosNichoVenta(mVentasComisionSectores obj){
	...
	public double TotalboletosColaboradorVenta(mVentasComisionSectores obj){
	...
	public String TotalboletosNichoVendidos(mVentasComisionSectores obj){
	...
	public String TotalboletosColaboradorVendidos(mVentasComisionSectores obj){
	...
	public void Totalboletos(mVentasComisionSectores obj){
	...
	public void TotalboletosAsignados(mVentasComisionSectores obj){
	...
	public int TotalboletosSector(mVentasComisionSectores obj){
		db.con();
		int total = 0;
	...
	public String TotalboletosSectorAsignados(mVentasComisionSectores obj){
	...
	public String TotalboletosNicho(mVentasComisionSectores obj){
	...
	public String TotalboletosNichoAsignados(mVentasComisionSectores obj){
	...
	public String TotalboletosColaborador(mVentasComisionSectores obj){
	...
	public String TotalboletosColaboradorAsignados(mVentasComisionSectores obj){
	...
	public ResultSet Sectores(mVentasComisionSectores obj){
...
public ResultSet Nichos(mVentasComisionSectores obj){
...
public ResultSet Colaboradores(mVentasComisionSectores obj){
...
public double MontoSector(mVentasComisionSectores obj){
...
public double MontoNicho(mVentasComisionSectores obj) {
...
public double MontoColaboradores(mVentasComisionSectores obj){
