...
public class mRetornoBoletos  extends SuperModel {
	...
	String sql = "SELECT S.PK_BOLETO,B.VENDIDO,B.ABONO,B.PK1,B.FOLIO,B.COSTO, B.TALONARIO, B.FORMATO, B.SORTEO, B.PK_TALONARIO,B.INCIDENCIA,  "
			...
			+ "FROM SORTEOS_BOLETOS S, BOLETOS B WHERE S.PK_BOLETO = B.PK1 AND S.PK_SORTEO = '"+idsorteo+"' AND B.VENDIDO='V' AND B.RETORNADO = 1 ";
		...
		System.out.println("RETORNO BOL: "+sql);
		ResultSet rs = db.getDatos(sql);
