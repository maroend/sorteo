...
public class mAsignacion extends SuperModel {
	...
	public void Sorteo(mAsignacion obj){
	...
	public void Totaltalonarios(mAsignacion obj){
	...
	public double montoSorteo(mAsignacion obj){
	...
	public void TotaltalonariosAsignados(mAsignacion obj){
	   	 
	   	 db.con();
	   	 String sql = "SELECT COUNT(*) AS TOTAL FROM SORTEOS_NICHOS_TALONARIOS WHERE PK_SORTEO = "+obj.getId()+" AND ASIGNADO = 1";
	   	 ResultSet rs = db.getDatos(sql);
	   	 try {
				if (rs != null) {
	...
	public void TotalboletosVendidos(mAsignacion obj){
	...
	public double TotalboletosVenta(mAsignacion obj){
	...
	public String TotalboletosSectorVendidos(mAsignacion obj){
	...
	public double TotalboletosSectorVenta(mAsignacion obj){
	...
	public double TotalboletosNichoVenta(mAsignacion obj){
	...
	public double TotalboletosColaboradorVenta(mAsignacion obj){
	...
	public String TotalboletosNichoVendidos(mAsignacion obj){
	...
	public String TotalboletosColaboradorVendidos(mAsignacion obj){
	...
	public void Totalboletos(mAsignacion obj){
	...
	public void TotalboletosAsignados(mAsignacion obj){
	...
	public int TotalboletosSector(mAsignacion obj) {
	...
	public int TotalboletosSectorAsignados(mAsignacion obj) {

		db.con();
		int total = 0;
		String sql = "SELECT COUNT(*) AS TOTAL FROM SORTEOS_NICHOS_BOLETOS WHERE PK_SORTEO = " + obj.getId()
	...
	public String TotalboletosNicho(mAsignacion obj){
	...
	public String TotalboletosNichoAsignados(mAsignacion obj){
	...
	public String TotalboletosColaborador(mAsignacion obj){
	...
	public String TotalboletosColaboradorAsignados(mAsignacion obj){
	...
	public ResultSet Sectores(mAsignacion obj){
...
public ResultSet Nichos(mAsignacion obj){
...
public ResultSet Colaboradores(mAsignacion obj){
...
public double MontoSector(mAsignacion obj){
...
public double MontoNicho(mAsignacion obj) {
...
public double MontoColaboradores(mAsignacion obj){
