...
//           [*******************]  cambio contra el modelo mPremios (Nombre de la clase)
public class mPremiosColaboradores extends SuperModel {
	...
	//                                    [*]  cambio contra el modelo mPremios (numero 2)
	private final int clave_beneficiario = 2; // 1=compradores,  2=Colaboradores 

	//     [*******************]  cambio contra el modelo mPremios (nombre del constructor)
	public mPremiosColaboradores() {
