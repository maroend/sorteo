...
public class mNichoDetalle extends SuperModel {
	...
	public mNichoDetalle() {
		// TODO Auto-generated constructor stub
	}
	
	public void Sorteo(mNichoDetalle obj){
	...
	public String Sector(mNichoDetalle obj){
	...
	public String Nicho(mNichoDetalle obj){
		...
		public void Totaltalonarios(mNichoDetalle obj){
		   	 
		   	 db.con();
		   	 String sql = "SELECT COUNT(*) AS TOTAL FROM SORTEOS_NICHOS_TALONARIOS WHERE PK_SORTEO = "+obj.getId()+" AND PK_SECTOR = "+obj.getIdsector()+" AND PK_NICHO = "+obj.getIdnicho()+"";
		   	 ResultSet rs = db.getDatos(sql);
		   	 try {
					if (rs != null) {
		...
		public double montoSorteo(mNichoDetalle obj){
			 
			 db.con();
			 String sql = "SELECT SUM(MONTO) AS TOTAL FROM SORTEOS_NICHOS_TALONARIOS WHERE PK_SORTEO = "+obj.getId()+" AND PK_SECTOR = "+obj.getIdsector()+" AND PK_NICHO = "+obj.getIdnicho()+"";
			 ResultSet rs = db.getDatos(sql);
			 double total = 0;
			 try {
				if (rs != null && rs.next()) {
		...
		public void TotaltalonariosAsignados(mNichoDetalle obj){
		...
		public void TotalboletosVendidos(mNichoDetalle obj){
		   	 
		   	 db.con();
		   	 String sql = "SELECT COUNT(*) AS TOTAL FROM SORTEOS_NICHOS_BOLETOS SB, BOLETOS B ";
		   	        sql += "WHERE B.PK1 = SB.PK_BOLETO AND SB.PK_SORTEO = "+obj.getId()+" AND SB.PK_SECTOR = "+obj.getIdsector()+" AND PK_NICHO = "+obj.getIdnicho()+" AND B.VENDIDO = 'T'";
		...
		public double TotalboletosVenta(mNichoDetalle obj){
		   	 
		   	 db.con();
		   	double total = 0; 
		   	 String sql = "SELECT ISNULL(SUM(B.ABONO),0) AS TOTAL FROM SORTEOS_NICHOS_BOLETOS SB, BOLETOS B ";
		   	        sql += "WHERE B.PK1 = SB.PK_BOLETO AND SB.PK_SORTEO = "+obj.getId()+" AND SB.PK_SECTOR = "+obj.getIdsector()+" AND PK_NICHO = "+obj.getIdnicho()+"";
		...
		public String TotalboletosSectorVendidos(mNichoDetalle obj){
		...
		public double TotalboletosSectorVenta(mNichoDetalle obj){
		...
		public double TotalboletosNichoVenta(mNichoDetalle obj){
		...
		public double TotalboletosColaboradorVenta(mNichoDetalle obj){
		...
		public String TotalboletosNichoVendidos(mNichoDetalle obj){
		...
		public String TotalboletosColaboradorVendidos(mNichoDetalle obj){
		...
		public void Totalboletos(mNichoDetalle obj){
		...
		public void TotalboletosAsignados(mNichoDetalle obj){
		...
		public String TotalboletosSector(mNichoDetalle obj){
		...
		public String TotalboletosSectorAsignados(mNichoDetalle obj){
		...
		public String TotalboletosNicho(mNichoDetalle obj){
		...
		public String TotalboletosNichoAsignados(mNichoDetalle obj){
		...
		public String TotalboletosColaborador(mNichoDetalle obj){
		...
		public String TotalboletosColaboradorAsignados(mNichoDetalle obj){
		...
		public ResultSet Sectores(mNichoDetalle obj){
	...
	public ResultSet Nichos(mNichoDetalle obj){
	...
	public ResultSet Colaboradores(mNichoDetalle obj){
