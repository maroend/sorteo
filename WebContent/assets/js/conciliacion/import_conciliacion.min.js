	...
	$('#processfile').html('');
 	...
 	$.ajax({ 
 	    ...
 	    success: function(response){
			...
			$('#logtable').show();
 	    	$('#logtable').html('<p>Asegurese de que el archivo tenga el formato adecuado (.xls)</p><p><a class="btn btn-primary m-r-5" href="ImportConciliacion">Regresar</a></p>');
		}
 	});
