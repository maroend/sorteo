...
function consultaBoletos() {
	$.ajax(
	{
		...
		cache: false,
		url: "BoletosVendidos",
		data: "view=Grafica&nivel=Sorteo",
		success: function(msg)
		{
			var info = jQuery.parseJSON(msg);
			var data_array = info[0];
			var data_sectores = info[1][0];
			...
			$('#grafica').highcharts(
			{
				...
				title: {
					text: 'Comparativo de cantidad de boletos entre Universidades'
				},
				xAxis: {
					categories: data_sectores
				},
				yAxis: [{
					title: { text: 'Boletos' }
				}],
