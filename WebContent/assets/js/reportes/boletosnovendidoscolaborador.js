...
function onkeyup_colfield_check(e){
	...
	$.ajax({ 
	    type: "GET",  
	    cache: false,
	    url: "BoletosNOVendidosColaborador",  
    ...
    var reporteTalonarios = function(){
   	...
   	$.ajax({ 
   	    ...
   	    success: function(msg){  
   	  	...
   	  	$('#totaldetalonariosnovendidos').html(res[10]);
	    	$('#totaldeboletosnovendidos').html(res[11]);
...
////////////////BOLETOS Y TALONARIOS COLABORADOR /////////////////////
    ...
    function reporteTalonariosColaborador(){
        
       	$.ajax({ 
       	    type: "GET",  
       	    cache: false,
       	    url: "BoletosNOVendidosColaborador",  
       	    data: "view=getBoletosTalonariosColaborador",  
       	    success: function(msg){  
       	 	handleListar();
   	    	var res = msg.split("|");
