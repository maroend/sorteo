...
function onkeyup_colfield_check(e){
	...
	$.ajax({ 
	    ...
	    success: function(msg){  
			...
			$("#sectore").html(response[1]);
			$("#nichoe").html(response[2]);
			$("#colaboradore").html(response[3]);
   	...
   	$.ajax({ 
   	    ...
   	    //alert(msg);
   	    	...
   	    	$('#totaldeboletosrobados').html(res[9]);
   	 	    $('#totaldeboletosRetornados').html(res[10]);
...
function ShowDetalleSector(sorteo,idsector,titulo){
	  ...
	  var show =	$("#data-elements-length").val();
		...
		$.ajax({ 
		    ...
		    cache: false,
		    url: "BoletosTransito",  
		    data: "view=BuscarSector&pg="+pag+"&show="+show+"&search="+search+"&idsector="+idsector,  
		    success: function(msg){  
...
function ShowDetalleNicho(sorteo,idsector,idnicho,titulo){
	...
	$.ajax({ 
	    ...
	    cache: false,
	    url: "BoletosTransito",  
	    data: "view=BuscarNichos&pg="+pag+"&show="+show+"&search="+search+"&idsector="+idsector+"&idnicho="+idnicho,  
	    success: function(msg){  
...
function ShowDetalleColaborador(sorteo,idsector,idnicho,idcolaborador,titulo){
	...
	$.ajax({ 
	    ...
	    cache: false,
	    url: "BoletosTransito",  
	    data: "view=BuscarColaborador&pg="+pag+"&show="+show+"&search="+search+"&idsector="+idsector+"&idnicho="+idnicho+"&idcolaborador="+idcolaborador,  
	    success: function(msg){  
