...
var ListarModalBoletos=function(){"use strict";return{init:function()
	...
	var handleListarModalBoletos = function()
	{
		...
		$.ajax({ 
			type: "GET",
			url: "AsignacionTalonariosNichos",
			data: "view=BuscarModalBoletos&pg="+pag+"&show="+show+"&search="+search+"&idsorteo="+idsorteo+"&idnicho="+idnicho,
			success: function(msg){  
...
var handleListar = function(){
	...
	$.ajax({ 
		type: "GET",  
		url: "AsignacionTalonariosNichos",  
		data: "view=Buscar&pg="+pag+"&show="+show+"&search="+search+"&idsorteo="+idsorteo+"&idnicho="+idnicho,
		success: function(msg){
...
function eliminarTalonario(id,idtalonario,idsorteo){
	
	var eliminar = true;
	
	if(confirm("Esta seguro de eliminar el talonario asignado?")){
  	    ...
  	    $.ajax({ 
  	  	type: "GET",  
  	  	url: "AsignacionTalonariosNichos",  
  	  	data: "view=EliminarANicho&id="+id+"&idtalonario="+idtalonario+"&eliminar="+eliminar+"&idsorteo="+idsorteo,  
  	  	success: function(msg){  
  	  		
  	  	//alert(msg);
  	    	
  	    	  //   $('#sector'+idsector).hide('slow', function(){ $('#sector'+idsector).remove(); });  
  	    	   $.gritter.add({title:"LA ASIGNACION DEL TALONARIO AL NICHO:",text:"ha sido eliminado con exito"});
...
function mensajeCargaNF5() {
 ...
 $.gritter.add({title:"DEVOLVER TALONARIO AL NICHO",text:"El Talonario existe en Colaboradores. Debe Devolver el Talonario al Nicho primero!"});

}

function mensajeCargaNF5B() {

	$.gritter.add({title:"DEVOLVER BOLETOS NO VENDIDOS AL NICHO",text:"Existen Boletos No vendidos en Colaboradores!. Debe Devolver los Boletos No Vendidos en Colaboradores al Nicho primero!"});
