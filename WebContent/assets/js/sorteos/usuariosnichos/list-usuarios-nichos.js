...
//
 ...
 /*FIN MODAL USUARIO */
    ...
    /*    function AsignarRoles(idusuario){        	
        	...
        	$("#aceptarmodal2").attr("onClick", "javascript:enviarRole("+idusuario+");return false;");         	
            $('#myModal2').modal('show');            
    ...
    function AsignarUsuarioSorteo(){
    	...
    	if(valores==""){
    		...
    		$.ajax({ 
                ...
                cache: false,
           	    url: "SorteosNichoUsuarios",  
           	    data: {action:action,idsorteo:idsorteo,valores:valores},
           	    success: function(msg){        	     
           	    	
           	     $.gritter.add({title:"USUARIOS AGREGADOS  AL NICHO",text:"Los usuarios se han agregado con exito"});
...
$.ajax({ 
    ...
    cache: false,
    url: "SorteosNichoUsuarios",  
    data: {action:action,idusuario:idusuario,idr:idr},  
    success: function(msg){  	    	
