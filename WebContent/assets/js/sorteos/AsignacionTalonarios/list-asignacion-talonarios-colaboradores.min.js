...
var ListarModalBoletos=function(){"use strict";return{init:function()
	...
	function GuardarAsignacionBoletos ()
	{
		...
		$.ajax({
			type: "POST",
			url: "AsignacionTalonariosColaboradores",
			data: { idboletos: idboletos,folio: folio,accion:accion},
			success: function(msg){
...
function GuardarAsignacionTalonariosColaboradores()
{
	...
	$.ajax({
		type: "POST",
		url: "AsignacionTalonariosColaboradores",
		data: { idsTalonarios: idsTalonarios,folio: folio},
		success: function(msg){
...
function RetornoTalonariosFC4() {
	...
	var idcolaborador = gup('idcolaborador');
		...
		$.ajax({ 
			type: "POST",  
			url: "AsignacionTalonariosColaboradores",
			data: { pk: pkTalonarioAEliminar, folio: folioTalonarioAEliminar, foliofc4: foliofc4, idsorteo: idsorteo, idsector: idsector, idnicho: idnicho, idcolaborador: idcolaborador,accion:'retornotalonariosfc4'},
...
function DevolverTalonarioFc5() {
	...
	var idcolaborador = gup('idcolaborador');
		...
		$.ajax({ 
			type: "POST",  
			url: "AsignacionTalonariosColaboradores",
			data: { pk: pkTalonarioADevolver, folio: folioTalonarioADevolver,  foliofc5: foliofc5,  idsorteo: idsorteo, idsector: idsector, idnicho: idnicho, idcolaborador: idcolaborador,accion:'devolvertalonariofc5'},
   ...
   var foliofc5B =	$("#foliofc5B").val();
	...
	var idcolaborador = gup('idcolaborador');
		...
		$.ajax({ 
			type: "POST",  
			url: "AsignacionTalonariosColaboradores",
			data: { pk: pkTalonarioADevolver5B, folio: folioTalonarioADevolver5B,  foliofc5B: foliofc5B,  idsorteo: idsorteo, idsector: idsector, idnicho: idnicho, idcolaborador: idcolaborador, accion:'devolvertalonariofc5B'},
