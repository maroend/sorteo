...
var reporteTalonarios = function() {
	...
	$.ajax({
		...
		success : function(msg) {
			...
			$('#totaldetalonarios').html(data.talonarios);
			$('#totaldetalonariosasignados').html(data.talonarios_asignados);
			$('#totaldetalonariosparcialvendidos').html(data.talonarios_parcial_vendidos);
			$('#totaldetalonariosvendidos').html(data.talonarios_vendidos);

			$('#totaldeboletos').html(data.boletos);
			$('#totaldeboletosasignados').html(data.talonarios_asignados);
			$('#totaldeboletosvendidos').html(data.boletos_vendidos);
			$('#totaldeboletosextraviados').html(data.boletos_extraviados);
			$('#totaldeboletosrobados').html(data.boletos_robados);

			handleListar();

		},
		error : function(msg){
			console.log('reporteTalonarios/ajax/error');
		}
...
function reporteTalonariosSector(idsorteo, idsector) {
	...
	$.ajax({
		...
		error : function(msg){
			console.log('reporteTalonariosSector/ajax/error');
		}
...
function reporteTalonariosNicho(idsorteo, idsector, idnicho) {
	...
	$.ajax({
		...
		error : function(msg){
			console.log('reporteTalonariosNicho/ajax/error');
		}
	});
...
function reporteTalonariosColaborador(idsorteo, idsector, idnicho,
		idcolaborador) {
	...
	$.ajax({
		...
		error : function(msg){
			console.log('reporteTalonariosColaborador/ajax/error');
		}
...
//	var idsectorb = $("#idsectorb").val();
	...
	//location.href = "BoletosSorteo?view=ExportExcel&pg=" + pag + "&show=" + show + "&search=" + search;
	
	
	
	
	 var url = "BoletosSorteo?view=ExportExcel&pg=" + pag + "&show=" + show + "&search=" + search;
