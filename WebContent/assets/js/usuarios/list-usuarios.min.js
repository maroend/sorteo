...
//
    		...
    		$.ajax({ 
                ...
                cache: false,
           	    ...
           	    success: function(msg){        	     
           	     ...
           	     $.gritter.add({title:"USUARIOS AGREGADOS",text:"Los usuarios se han agregado con exito"});
  ...
  if( $('#formulario').parsley().validate() ){    	
	...
	$.ajax({ 
      ...
      cache: false,
	    url: "Usuarios.do",  
	    data: "view=BuscarUsuarios&pg="+pag+"&show="+show+"&search="+search, 
	    success: function(msg){  
...
function Borrar(idusuario){ 
	...
	var confirm=window.confirm("Esta seguro de borrar el usuario?");
    if (confirm==true) { 	
	 ...
	 $('div.block').block({ 
		...
		$.ajax({ 
            ...
            cache: false, 
            url: "Usuarios.do",  
            data: "view=Borrar&idusuario="+idusuario,  
            success: function(msg){  
        ...
        if(msg.trim()!=""){ 
        	...
        	if(msg.trim()=="-1"){         		
        		...
        		var r = window.confirm("El usuario no se puede eliminar, por que esta asignado a otras tablas!\nDeseas Eliminarlo de todas maneras(Se eliminaran en las tablas donde este asignado)?");
        		
        		if (r == true) {        		
        			
        			Borrar_DependenciasUsuario(idusuario);         			
...
function Borrar_DependenciasUsuario(idusuario){ 
	 ...
	 $('div.block').block({ 
			...
			$.ajax({ 
	            ...
	            cache: false, 
	            url: "Usuarios.do",  
	            data: "view=BorrarDependencias&idusuario="+idusuario,  
	            success: function(msg){  
