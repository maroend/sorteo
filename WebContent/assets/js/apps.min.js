...
var __msg_sin_conexion='<div><div style="float: left;width: 50pt;height: 50pt;padding: 10pt;"><i class="fa fa-exclamation-triangle" style="font-size: 30pt;color: #cac39a;"></i></div><div style="float: left;"><h5 style="color: gray;"><p> La conexion a Internet se ha interrumpido o es un poco lenta.</p><p>Por favor actualice la p&aacute;gina (presione F5).</p></h5></div></div>';
var __msg_sin_conexion_2='<br/><div style="margin-top:40pt;">'+__msg_sin_conexion+'</div>'; 
